...
public class makeAnimation : MonoBehaviour {
    ...
    void saveAnimationClip() {
        AssetDatabase.CreateAsset(
            animClip,
            AssetDatabase.GenerateUniqueAssetPath("Assets/InitialBigAnimation.anim")
            );
    ...
    void makeKeyFrame(Transform parent, Transform tartgetParent, string parentPath) {
        for (int i = 0; i < parent.childCount; ++i)
        {
            if (parent.GetChild(i).gameObject.GetComponent<Trump>() != null || parent.GetChild(i).gameObject.tag == "makeKeyFrame")
            {
                ...
                Keyframe startKeyframePX2 = new Keyframe(1f, tfTarget.localPosition.x);
                Keyframe startKeyframePY2 = new Keyframe(1f, tfTarget.localPosition.y);
                Keyframe startKeyframePZ2 = new Keyframe(1f, tfTarget.localPosition.z);
                ...
                Keyframe startKeyframeRX2 = new Keyframe(1f, tfTarget.localRotation.x);
                Keyframe startKeyframeRY2 = new Keyframe(1f, tfTarget.localRotation.y);
                Keyframe startKeyframeRZ2 = new Keyframe(1f, tfTarget.localRotation.z);
                Keyframe startKeyframeRW2 = new Keyframe(1f, tfTarget.localRotation.w);
